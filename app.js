...
// Thank you route (form data shown)
app.get('/thankyou', (req, res) => {
  const { name, gender, email, message } = req.query;
  res.render('thankyou', { fullname,phone ,adress });
});
//checkout route
...
app.get('/register', (req, res) => {
  const state = { login: true };
  const head = { title: "register", description: "register page", keywords: "name,adress,gender" };
